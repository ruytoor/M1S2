...
public class Menus {
	...
	String addMenuBar() {
		...
		addPlugInItem(window, "Show All", "ij.plugin.WindowOrganizer(\"show\")", KeyEvent.VK_ENTER, false);
		// lo: changé ce raccourci (précieux !) de KeyEvent.VK_CLOSE_BRACKET en KeyEvent.VK_ENTER
