...
- b->addMoment(un Vector3 f, un Vector3 p) => ajoute le moment de la force f appliquée en p
- si l'attachement par un ressort est actif sur la boite b (_cursorActive == true) :
  - b->attachWorld() donne le point d'attache du ressort à la boite dans le repère du monde
