...
void GLView::initializeGL() {
    ...
    float tf[]={0.8,0.8,0.8,0.0};
    glLightfv(GL_LIGHT0,GL_AMBIENT,tf);
    ...
    glMaterialfv(GL_FRONT,GL_SPECULAR,tf3); // coefficient Ks du spéculaire. (rouge,vert,bleu,alpha) = (0,0.2,0.8,0). Récupéré dans le vertex/fragment shader par gl_FrontMaterial.specular
